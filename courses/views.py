...
class CoursesView(ViewSet):
    ...
    @extend_schema(
        ...
        description="Get detailed information about a specific course with all lessons and sections (published courses only). Full details only for enrolled users or the course trainer.",
